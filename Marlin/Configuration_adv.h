...
//
  ...
  #define HEATER_CHAMBER_PIN       0   // Required heater on/off pin (example: SKR 1.4 Turbo HE1 plug)
  //#define HEATER_CHAMBER_INVERTING false
  //#define FAN1_PIN                   10   // Remove the fan signal on pin P2_04 (example: SKR 1.4 Turbo HE1 plug)
  ...
  //#define CHAMBER_FAN               // Enable a fan on the chamber
    ...
    #define CHAMBER_FAN_MODE      1   // Fan control mode: 0=Static; 1=Linear increase when temp is higher than target; 2=V-shaped curve; 3=similar to 1 but fan is always on.
      ...
      #define CHAMBER_FAN_FACTOR 0   // PWM increase per °C difference from target
...
//
  ...
  #define COOLER_DEFAULT_TEMP     25  // (°C)
  #define TEMP_COOLER_HYSTERESIS   1  // (°C) Temperature proximity considered "close enough" to the target
  #define COOLER_PIN               10  // Laser cooler on/off pin used to control power to the cooling element (e.g., TEC, External chiller via relay)
 ...
 */ 
#define E0_AUTO_FAN_PIN PE0
#define E1_AUTO_FAN_PIN PC12
...
#define SENSORLESS_BACKOFF_MM  { 2, 2, 0 , 2, 2 ,2}  // (linear=mm, rotational=°) Backoff from endstops before sensorless homing
...
#define AXIS_RELATIVE_MODES { false, false, false, false, false, true, true}
...
#define MICROSTEP_MODES { 16, 16, 1, 4, 4, 1 } // [1,2,4,8,16]
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 100*60, 100*60, 20*60, 10*60, 10*60, 50*60, 50*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_TITLE "Homing"
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "Homing done"
  ...
  #define MAIN_MENU_ITEM_2_DESC "Home Z"
  #define MAIN_MENU_ITEM_2_GCODE "G28 Z\nM503"
  #define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_3_DESC "Home pipettes"
  #define MAIN_MENU_ITEM_3_GCODE "G28 A B\nM503"
