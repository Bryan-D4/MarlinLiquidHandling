...
#define STRING_CONFIG_H_AUTHOR "(Bryan A, default config)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT -1 // Normally 0, but -1 for 32 bit boards loaded with sd card
...
//#define BAUDRATE_2 38400   // :[2400, 9600, 19200, 38400, 57600, 115200, 250000, 500000, 1000000] Enable to override BAUDRATE
...
#define HEATER_0_MAXTEMP 60 // Controlled in temperature.cpp line 1702
...
#define BED_MAXTEMP      80 // Controlled in temperature.cpp line 1848-1855
...
//#define ENDSTOPPULLDOWNS
  ...
  #define ENDSTOPPULLDOWN_ZMIN // Change pin to PF6 with 5V on VFAN6, PF5 has external pullup resistor
...
#define Z_MIN_ENDSTOP_HIT_STATE HIGH // HIGH for optical because of NOT gate
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 10, 1000,1000 } // ...or, set your own edit limits
#endif
...
#define INVERT_Z_DIR false // false for use with optoswitch
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (15*60),(15*60),(15*60),(50*60) }
